...
// console.log(typeof parseInt(num) === typeof num2);
...
// let randNum2 = Math.ceil(Math.random() * (100 - 50) + 50);
// console.log(randNum2);

// let randNum3 = Math.ceil(Math.random() * 256);
// console.log(randNum3);

// let text = "Javascript";
// console.log(text[0]);

// let text2a = "1 1 1 1 1\n2 1 2 4 8\n3 1 3 9 27\n4 1 4 16 64\n5 1 5 25 125";
// console.log(text2a);

// let text2b =
//   "You cannot end a sentence with because because because is a conjunction";
// console.log(text2b.indexOf("is"));
// console.log(text2b.substring(31, 55));
...
// let sentence2 =
//   "%I $am@% a %tea@cher%, &and& I lo%#ve %te@a@ching%;. The@re $is no@th@ing as rewarding as educa@ting &and& @emp%o@weri@ng peo@ple. ;I found tea@ching m%o@re interesting tha@n any ot#her %jo@b. %Do@es thi%s mo@tiv#ate yo@u to be a tea@cher!? %Th#is 30#Days&OfJavaScript &is al@so $the $resu@lt of a &love& of tea&ching";
// let cleanSentence2Regex = sentence2.replace(/[@\$%#&!;]/gi, "");
// console.log(cleanSentence2Regex);

// let sentence3 =
//   "He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.";
// let numarr = sentence3.match(/[0-9]+/gi);
// console.log(numarr);
// let sumOfAll =
//   parseInt(numarr[0]) * 12 + parseInt(numarr[1]) + parseInt(numarr[2]) * 12;
